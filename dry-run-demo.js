/**
 * DRY-RUN DEMO - Path C (Recommended by both Opus and GPT)
 * Build transaction, validate with policy engine, show "ready to broadcast"
 * This is actually MORE impressive for a security-focused product!
 */
...
async function dryRunDemo() {
  ...
  console.log({
    ...
    payableAmount: `${AMOUNT_HBAR} HBAR`,
    gas: 500000,
    function: "multicall",
    operations: [
      "exactInput (swap HBAR for SAUCE)",
      "refundETH (return excess HBAR)"
    ],
    expectedResult: `Receive ${minSauce.toFixed(2)}+ SAUCE`,
